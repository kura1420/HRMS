...
if (is_file(__DIR__ .'/ovrtime.php-handler.php')) {
	require_once __DIR__ .'/ovrtime.php-handler.php';
}

/**
 * hrms/transaction/ovrtime/ovrtime.php
 *
 * ===================================================================
 * Entry point Program Module ovrtime
 * ===================================================================
 ...
 * awal dibuat tanggal 07/06/2024
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\ovrtime_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new ovrtime_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
