...
import * as hnd from  './ovrtime-edit-hnd.mjs'
...
const obj = {
	txt_ovrtime_id: $('#pnl_edit-txt_ovrtime_id'),
	txt_ovrtime_code: $('#pnl_edit-txt_ovrtime_code'),
	cbo_empl_id: $('#pnl_edit-cbo_empl_id'),
	cbo_docapprv_id: $('#pnl_edit-cbo_docapprv_id'),
	txt_ovrtime_rejectnotes: $('#pnl_edit-txt_ovrtime_rejectnotes'),
	chk_ovrtime_isrequest: $('#pnl_edit-chk_ovrtime_isrequest'),
	txt_ovrtime_requestby: $('#pnl_edit-txt_ovrtime_requestby'),
	txt_ovrtime_requestdate: $('#pnl_edit-txt_ovrtime_requestdate'),
	chk_ovrtime_isapproved: $('#pnl_edit-chk_ovrtime_isapproved'),
	txt_ovrtime_approveby: $('#pnl_edit-txt_ovrtime_approveby'),
	txt_ovrtime_approvedate: $('#pnl_edit-txt_ovrtime_approvedate'),
	chk_ovrtime_isapprovalprogress: $('#pnl_edit-chk_ovrtime_isapprovalprogress'),
	chk_ovrtime_isdecline: $('#pnl_edit-chk_ovrtime_isdecline'),
	txt_ovrtime_declineby: $('#pnl_edit-txt_ovrtime_declineby'),
	txt_ovrtime_declinedate: $('#pnl_edit-txt_ovrtime_declinedate'),
	chk_ovrtime_ispayment: $('#pnl_edit-chk_ovrtime_ispayment'),
	txt_ovrtime_paymentby: $('#pnl_edit-txt_ovrtime_paymentby'),
	txt_ovrtime_paymentdate: $('#pnl_edit-txt_ovrtime_paymentdate'),
	txt_ovrtime_executeby: $('#pnl_edit-txt_ovrtime_executeby'),
	txt_ovrtime_executedate: $('#pnl_edit-txt_ovrtime_executedate')
}
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.ovrtime_isrequest = '0'
		data.ovrtime_isapproved = '0'
		data.ovrtime_isapprovalprogress = '0'
		data.ovrtime_isdecline = '0'
		data.ovrtime_ispayment = '0'
		...
		$ui.getPages().ITEMS['pnl_editovrtimedtgrid'].handler.createnew(data, options)
...
function btn_print_click() {
	...
	var args = {
		...
		reportmodule: `${module}/ovrtime.xprint?renderto=${renderto}&format=${format}`,
		handled: false
	}
...
async function btn_action_click(args) {
	...
	var docname = 'Overtime'
	var txt_version = obj.txt_ovrtime_version;
	var chk_iscommit = obj.chk_ovrtime_iscommit;
