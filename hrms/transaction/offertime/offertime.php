...
if (is_file(__DIR__ .'/offertime.php-handler.php')) {
	require_once __DIR__ .'/offertime.php-handler.php';
}

/**
 * hrms/transaction/offertime/offertime.php
 *
 * ===================================================================
 * Entry point Program Module offertime
 * ===================================================================
 ...
 * awal dibuat tanggal 30/05/2024
 * terakhir di generate tanggal 04/06/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\offertime_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new offertime_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
