...
/**
 * hrms/transaction/offertime/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends offertimeBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->offertime_code = strtoupper($obj->offertime_code);


			if ($obj->offertime_rejectnotes=='') { $obj->offertime_rejectnotes = '--NULL--'; }


			unset($obj->offertime_rejectnotes);
			unset($obj->offertime_isrequest);
			unset($obj->offertime_requestby);
			unset($obj->offertime_requestdate);
			unset($obj->offertime_isapproved);
			unset($obj->offertime_approveby);
			unset($obj->offertime_approvedate);
			unset($obj->offertime_isdeclined);
			unset($obj->offertime_declineby);
			unset($obj->offertime_declinedate);
