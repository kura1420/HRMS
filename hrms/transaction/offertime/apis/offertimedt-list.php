...
/**
 * hrms/transaction/offertime/apis/offertimedt-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel offertimedt offertime (trn_offertimedt)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('offertime_name', 'offertime_id_type', $record, 'mst_offertime', 'offertime_name', 'offertime_id');
