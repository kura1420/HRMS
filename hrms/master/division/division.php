...
if (is_file(__DIR__ .'/division.php-handler.php')) {
	require_once __DIR__ .'/division.php-handler.php';
}

/**
 * hrms/master/division/division.php
 *
 * ===================================================================
 * Entry point Program Module division
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\division_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new division_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
