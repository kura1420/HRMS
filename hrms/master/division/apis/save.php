...
/**
 * hrms/master/division/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header division (mst_division)
 *
...
$API = new class extends divisionBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->division_code = strtoupper($obj->division_code);


			if ($obj->division_descr=='') { $obj->division_descr = '--NULL--'; }
