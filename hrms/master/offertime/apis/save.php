...
/**
 * hrms/master/offertime/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header offertime (mst_offertime)
 *
...
$API = new class extends offertimeBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->offertime_descr=='') { $obj->offertime_descr = '--NULL--'; }
			...
			try {
				...
				$sqlFieldList = [
					'offertime_id' => 'A.`offertime_id`', 'offertime_name' => 'A.`offertime_name`', 'offertime_descr' => 'A.`offertime_descr`', 'offertime_isdisabled' => 'A.`offertime_isdisabled`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_offertime A";
				$sqlWhere = $where->sql;
