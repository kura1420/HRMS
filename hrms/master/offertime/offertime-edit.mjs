...
const obj = {
	...
	txt_offertime_name: $('#pnl_edit-txt_offertime_name'),
	txt_offertime_descr: $('#pnl_edit-txt_offertime_descr'),
	chk_offertime_isdisabled: $('#pnl_edit-chk_offertime_isdisabled')
}
