...
/**
 * hrms/master/paidleave/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends paidleaveBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->paidleave_code = strtoupper($obj->paidleave_code);


			if ($obj->paidleave_descr=='') { $obj->paidleave_descr = '--NULL--'; }
