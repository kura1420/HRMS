...
import * as hnd from  './paidleave-edit-hnd.mjs'
...
const obj = {
	txt_paidleave_id: $('#pnl_edit-txt_paidleave_id'),
	txt_paidleave_code: $('#pnl_edit-txt_paidleave_code'),
	txt_paidleave_name: $('#pnl_edit-txt_paidleave_name'),
	chk_paidleave_isdisabled: $('#pnl_edit-chk_paidleave_isdisabled'),
	chk_paidleave_iscutting: $('#pnl_edit-chk_paidleave_iscutting'),
	txt_paidleave_descr: $('#pnl_edit-txt_paidleave_descr'),
	chk_paidleave_expenable: $('#pnl_edit-chk_paidleave_expenable'),
	txt_paidleave_qty: $('#pnl_edit-txt_paidleave_qty'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_paidleave_id,
		autoid: true,
		logview: 'mst_paidleave',
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		/*
		if (result.record.period_id==null) { result.record.period_id='--NULL--'; result.record.period_name='NONE'; }
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.paidleave_isdisabled = '0'
		data.paidleave_iscutting = '0'
		data.paidleave_expenable = '0'
		data.paidleave_qty = 0

		data.period_id = '--NULL--'
		data.period_name = 'NONE'
...
function form_idsetup(options) {
	var objid = obj.txt_paidleave_id
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['period_id', ];
...
async function form_datasaved(result, options) {
	...
	/*
	form.setValue(obj.cbo_period_id, result.dataresponse.period_name!=='--NULL--' ? result.dataresponse.period_id : '--NULL--', result.dataresponse.period_name!=='--NULL--'?result.dataresponse.period_name:'NONE')
