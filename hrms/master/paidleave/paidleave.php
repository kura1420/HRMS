...
if (is_file(__DIR__ .'/paidleave.php-handler.php')) {
	require_once __DIR__ .'/paidleave.php-handler.php';
}

/**
 * hrms/master/paidleave/paidleave.php
 *
 * ===================================================================
 * Entry point Program Module paidleave
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\paidleave_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new paidleave_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
