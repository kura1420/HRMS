...
ALTER TABLE `mst_empl` ADD COLUMN IF NOT EXISTS  `division_id` varchar(36) NOT NULL  AFTER `empl_dtjoin`;
...
ALTER TABLE `mst_empl` MODIFY COLUMN IF EXISTS  `division_id` varchar(36) NOT NULL   AFTER `empl_dtjoin`;
