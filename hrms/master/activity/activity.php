...
if (is_file(__DIR__ .'/activity.php-handler.php')) {
	require_once __DIR__ .'/activity.php-handler.php';
}

/**
 * hrms/master/activity/activity.php
 *
 * ===================================================================
 * Entry point Program Module activity
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\activity_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new activity_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
