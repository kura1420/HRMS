...
import * as hnd from  './activity-edit-hnd.mjs'
...
const obj = {
	txt_activity_id: $('#pnl_edit-txt_activity_id'),
	txt_activity_name: $('#pnl_edit-txt_activity_name'),
	txt_activity_descr: $('#pnl_edit-txt_activity_descr'),
	chk_activity_isdisabled: $('#pnl_edit-chk_activity_isdisabled')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_activity_id,
		autoid: true,
		logview: 'mst_activity',
