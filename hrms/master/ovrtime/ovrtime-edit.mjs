...
const obj = {
	...
	txt_ovrtime_name: $('#pnl_edit-txt_ovrtime_name'),
	txt_ovrtime_descr: $('#pnl_edit-txt_ovrtime_descr'),
	chk_ovrtime_isdisabled: $('#pnl_edit-chk_ovrtime_isdisabled')
}
