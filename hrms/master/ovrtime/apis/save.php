...
/**
 * hrms/master/ovrtime/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header ovrtime (mst_ovrtime)
 *
...
$API = new class extends ovrtimeBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->ovrtime_descr=='') { $obj->ovrtime_descr = '--NULL--'; }
			...
			try {
				...
				$sqlFieldList = [
					'ovrtime_id' => 'A.`ovrtime_id`', 'ovrtime_name' => 'A.`ovrtime_name`', 'ovrtime_descr' => 'A.`ovrtime_descr`', 'ovrtime_isdisabled' => 'A.`ovrtime_isdisabled`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_ovrtime A";
				$sqlWhere = $where->sql;
