...
import * as hnd from  './docapprv-edit-hnd.mjs'
...
const obj = {
	txt_docapprv_id: $('#pnl_edit-txt_docapprv_id'),
	txt_docapprv_name: $('#pnl_edit-txt_docapprv_name'),
	txt_docapprv_descr: $('#pnl_edit-txt_docapprv_descr'),
	chk_docapprv_isdisabled: $('#pnl_edit-chk_docapprv_isdisabled')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_docapprv_id,
		autoid: false,
		logview: 'mst_docapprv',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editdocapprvlevlgrid'].handler.createnew(data, options)
