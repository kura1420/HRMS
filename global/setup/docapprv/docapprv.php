...
if (is_file(__DIR__ .'/docapprv.php-handler.php')) {
	require_once __DIR__ .'/docapprv.php-handler.php';
}

/**
 * global/setup/docapprv/docapprv.php
 *
 * ===================================================================
 * Entry point Program Module docapprv
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\docapprv_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new docapprv_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
