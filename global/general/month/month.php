...
if (is_file(__DIR__ .'/month.php-handler.php')) {
	require_once __DIR__ .'/month.php-handler.php';
}

/**
 * global/general/month/month.php
 *
 * ===================================================================
 * Entry point Program Module month
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\month_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new month_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
