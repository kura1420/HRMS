...
import * as hnd from  './month-edit-hnd.mjs'
...
const obj = {
	txt_month_id: $('#pnl_edit-txt_month_id'),
	txt_month_name: $('#pnl_edit-txt_month_name')
}
