...
import * as hnd from  './period-edit-hnd.mjs'
...
const obj = {
	txt_period_id: $('#pnl_edit-txt_period_id'),
	txt_period_name: $('#pnl_edit-txt_period_name'),
	txt_period_descr: $('#pnl_edit-txt_period_descr'),
	chk_period_isdisabled: $('#pnl_edit-chk_period_isdisabled')
}
