...
import * as hnd from  './typereq-edit-hnd.mjs'
...
const obj = {
	txt_typereq_id: $('#pnl_edit-txt_typereq_id'),
	txt_typereq_name: $('#pnl_edit-txt_typereq_name')
}
