...
if (is_file(__DIR__ .'/typereq.php-handler.php')) {
	require_once __DIR__ .'/typereq.php-handler.php';
}

/**
 * purchase/master/typereq/typereq.php
 *
 * ===================================================================
 * Entry point Program Module typereq
 * ===================================================================
 ...
 * terakhir di generate tanggal 15/06/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\typereq_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new typereq_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
