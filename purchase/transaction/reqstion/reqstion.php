...
if (is_file(__DIR__ .'/reqstion.php-handler.php')) {
	require_once __DIR__ .'/reqstion.php-handler.php';
}

/**
 * purchase/transaction/reqstion/reqstion.php
 *
 * ===================================================================
 * Entry point Program Module reqstion
 * ===================================================================
 ...
 * awal dibuat tanggal 15/06/2024
 * terakhir di generate tanggal 16/06/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\reqstion_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new reqstion_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
