...
/**
 * purchase/transaction/reqstion/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends reqstionBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->reqstion_dt = (\DateTime::createFromFormat('d/m/Y',$obj->reqstion_dt))->format('Y-m-d');

			$obj->reqstion_code = strtoupper($obj->reqstion_code);


			if ($obj->reqstion_rejectnotes=='') { $obj->reqstion_rejectnotes = '--NULL--'; }


			unset($obj->reqstion_rejectnotes);
			unset($obj->reqstion_isrequest);
			unset($obj->reqstion_requestby);
			unset($obj->reqstion_requestdate);
			unset($obj->reqstion_isapproved);
			unset($obj->reqstion_approveby);
			unset($obj->reqstion_approvedate);
			unset($obj->reqstion_isapprovalprogress);
			unset($obj->reqstion_isdecline);
			unset($obj->reqstion_declineby);
			unset($obj->reqstion_declinedate);
			unset($obj->reqstion_ispayment);
			unset($obj->reqstion_executeby);
			unset($obj->reqstion_executedate);
			...
			try {
				...
				$dataresponse = array_merge($record, [
					...
					'reqstion_dt' => date("d/m/Y", strtotime($row['reqstion_dt'])),
