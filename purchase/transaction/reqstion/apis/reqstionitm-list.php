...
/**
 * purchase/transaction/reqstion/apis/reqstionitm-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel reqstionitm reqstion (trn_reqstionitm)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('typereq_name', 'typereq_id', $record, 'mst_typereq', 'typereq_name', 'typereq_id');
